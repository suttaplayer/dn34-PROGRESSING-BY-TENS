import { DeterminantQuotationString, JsonUtils, PatternResponseJson, ProgressingByTens, UserPatternRequestJson } from "../api/collaboration-API.ts";
...
for pattern "${ProgressingByTens.config["pattern-names"][this.request.categoryKey][this.request.progressionIndex-1]}" has as its originating context:
    ...
    private identifyAndSetEnterFromState() {
    ...
    private identifyAndSetExitToState() {
    ...
    private identifyAndSetTargetAudience() {
