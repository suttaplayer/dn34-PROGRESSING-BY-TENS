...
export type SubjectJson = {
    ...
    "target-practitioner": AudienceKey[],   /* subject's audience (eg. ["conviction-dhamma-follower", "stream-enterer", "once-returner"]) */
}
    ...
    "subject": [
        {
            ...
            "target-practitioner": ["conviction-dhamma-follower", "one-in-training"]
        }, {
            "name": "True Dhamma",
            "focus": ["listening"],
            "enter-from-state": "stress",
...
*/
export type ScopeJson = PatternTopicJson &{
    "pattern-name": string, 
    "subject": SubjectJson[], 
}
...
*/
export type UserPatternRequestJson = PatternTopicJson &{
