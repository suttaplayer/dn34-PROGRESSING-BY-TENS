...
exports.ConsciousMoment = void 0;
const Consciousness_1 = require("./Consciousness");
class ConsciousMoment {
    constructor(being, context, previousIntention) {
        this.being = being;
    ...
    process() {
        ...
        const consciousness = new Consciousness_1.Consciousness(consciousnessSeed);
...
exports.ConsciousMoment = ConsciousMoment;
