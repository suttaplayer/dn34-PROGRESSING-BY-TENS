...
@enduml
```
![json-pattern-gen-inst-problem-space](./json-pattern-gen-inst-problem-space.png)
...
0. **Command:execute** JSON Scope Generation in source "json-0-scope-generation-instruction-manual.md"
