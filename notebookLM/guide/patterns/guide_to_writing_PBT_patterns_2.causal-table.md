...
to be effective at the set of tasks related to causal-table generation, notebooklm must be able to establish connections between different representations of expression in a given context. for eg. learning = listening, person of integrity = admirable friendship, person consumate in virtue/view = one-in training, person consumate in concentration = non-returner or higher etc.

in this set of tasks notebooklm will thus be encouraged to abstract and generalise a term or experssion to its most frequent representation from the sources in order to optimise the causal-table.
...
use the source "guide_causation_expression.md" for some candidate causation expressions as a means for searching. note, this causation expression guide is not comprehensive! it declares many common cases:
...
the source "PBT-collaboration-API.ts.txt" typescript file provides many key types required for communication and exchange. the key classifier with respect to causation is:
```typescript
...
1. do not use the "skips-to" feature when creating entries for the "Causal-Table". such use will mask/hide the clear causal relationships
1. always specify the "quotation-index" from the patternQuotationsJson["Causal-Table"] from which the relationship is based

parsing the quotation from Causal References > Example 1 & 2 should result in:
```typescript
...
const example1: CauseAndEffectJson[] = [
  {"cause": "inappropriate attention", "effect": "wrong view", "quotation-index": 2}, // refers examples_quotations[2]
  {"cause": "wrong view", "effect": "slowness of awareness", "co-arised-with": true, "quotation-index": 2}, // refers examples_quotations[2]
  {"cause": "slowness of awareness", "effect": "self-identification view", "quotation-index": 2}, // refers examples_quotations[2]
  {"cause": "self-identification view", "effect": "uncertainty", "co-arised-with": true, "quotation-index": 2}, // refers examples_quotations[2]
  {"cause": "uncertainty", "effect": "grasping at habits & practices", "co-arised-with": true, "quotation-index": 2}, // refers examples_quotations[2]

  {"cause": "admirable friendship", "effect": "hearing the true Dhamma", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "hearing the true Dhamma", "effect": "conviction", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "conviction", "effect": "appropriate attention", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "appropriate attention", "effect": "mindfulness & alertness", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "mindfulness & alertness", "effect": "sense restraint", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "sense restraint", "effect": "right conduct", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "right conduct", "effect": "four establishings of mindfulness", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "four establishings of mindfulness", "effect": "seven factors for awakening", "quotation-index": 4}, // refers examples_quotations[4]
  {"cause": "seven factors for awakening", "effect": "clear knowing & release", "quotation-index": 4}, // refers examples_quotations[4]
]
```
...
**NotebookLM Task**
1. for (const subject of progressionByTensContextJson["subject"]):
