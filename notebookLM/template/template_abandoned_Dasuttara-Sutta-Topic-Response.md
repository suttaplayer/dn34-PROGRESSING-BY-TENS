...
title Abandonment of Unskillful Qualities (State Progression)
header Generated by notebooklm on <generation-date>

state "Uninstructed/Hindered" as Uninstructed <<initial>>
state "Mind Defiled" as Defiled
state "Practicing Dhamma" as Practice
state "Qualities Abandoned" as Abandoned
state "Mind Purified & Calmed" as Purified
state "Liberated & Unbound" as Liberated <<final>>

Uninstructed --> Defiled : No attention to skillful / Attend to unfit
Defiled --> Practice : Discern Fit for Attention / Apply Right Practice
Practice --> Abandoned : Through Disenchantment & Dispassion
Abandoned --> Purified : Leads to Mental Purity
Purified --> Liberated : Leads to Release & No Further Becoming

Defiled --> Defiled : Lack of Practice
...
title Qualities and Outcomes in Abandonment (Class Diagram)
header Generated by notebooklm on <generation-date>
...
class DhammaPractice {
  + Abandon(UnskillfulQuality)
  + Develop(SkillfulQuality)
  + PurifyMind()
  + CultivateInsight()
}
...
UnskillfulQuality "1..*" --> "1" Mind : defiles
Mind "1" --> "1..*" Suffering : leads to (if Defiled)

DhammaPractice "1" --> "1..*" UnskillfulQuality : abandons
DhammaPractice "1" --> "1..*" SkillfulQuality : develops

SkillfulQuality "1..*" --> "1" Mind : purifies
Mind "1" --> "1" Liberation : leads to (if Purified)
Liberation "1" --> "1..*" Suffering : ends
