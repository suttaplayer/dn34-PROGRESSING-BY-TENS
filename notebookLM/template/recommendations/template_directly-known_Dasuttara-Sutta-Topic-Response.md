...
```plantuml
@startuml
title "Entities and Relationships in Direct Knowledge"
header <gemini-model-id> - <generation-date>
...
Practitioner "1" -- "1" Dhamma : "practices"
Teacher "1" -- "*" Practitioner : "instructs"
PeopleOfIntegrity "1" -- "*" Practitioner : "associates with"
Practitioner "1" -- "1" SkillfulQualities : "cultivates"
Practitioner "1" -- "1" UnskillfulQualities : "abandons"

SkillfulQualities "1" -- "1" DirectKnowledge : "leads to"
DirectKnowledge "1" -- "1" Release : "results in"

UnskillfulQualities "1" -- "1" Practitioner : "hinder/defile"

Dhamma "1" -- "1" DirectKnowledge : "is the object of"
